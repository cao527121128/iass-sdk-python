...
def delete_snapshot(snapshots_id):
    print("子线程启动")
    ...
    #删除备份
    ret = conn.delete_snapshots(snapshots=snapshots_id)
    ...
    if ret.get("ret_code") == 0:
        ...
        while num < 300:
            ...
            if status == "successful":
                print("delete_snapshots successful")
                break
...
if __name__ == "__main__":
    ...
    #创建子线程--删除备份
    t = threading.Thread(target=delete_snapshot,args=(snapshots_id,))
    t.start()
    t.join()
